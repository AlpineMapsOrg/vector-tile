...
template <typename F, typename V> struct result_of_unary_visit<F, V, typename enable_if_type<typename F::invoke_result>::type> {
    using type = typename F::invoke_result;
};
...
template <typename F, typename V> struct result_of_binary_visit<F, V, typename enable_if_type<typename F::invoke_result>::type> {
    using type = typename F::invoke_result;
};
